...
export async function POST(request) {
  try {
    ...
    const phoneCheck = await client.query('SELECT * FROM users WHERE phone = $1', [phone]);
    ...
    // Insert user
    await client.query('INSERT INTO users (email, phone, username, password_hash) VALUES ($1, $2, $3, $4)', [email, phone, username, passwordHash]);
