  ...
  return (
    <>
      ...
      <div className="group fixed left-0 right-0 top-0 z-50 -translate-y-[calc(100%-8px)] transition-transform duration-300 ease-in-out hover:translate-y-0">
        <header className="flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-pink-700 via-pink-600 to-rose-500 px-4 sm:px-8 py-3 sm:py-4 shadow-[0_6px_28px_rgba(219,39,119,0.4)]">
          {!isUserHome && (
            <Link
              href="/userSystem/user"
              className="inline-flex items-center gap-1 sm:gap-1.5 rounded-full border border-white/30 bg-white/10 px-3 sm:px-5 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold text-white transition hover:bg-white/25 active:scale-95"
            >
