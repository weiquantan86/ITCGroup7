            ...
            <div className="w-full max-w-[1280px]" style={selectionFit.scaledStyle}>
              ...
              {!hasConfiguredDifficulty ? (
                <div className="mx-auto w-full max-w-[1040px]">
                  ...
                  <div className="mt-4 space-y-3">
                    <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-3" style={difficultySectionStyle}>
                ...
                <>
                  ...
                  <div className="mt-4 flex justify-center">
                    <button
                      ...
                      className="inline-flex h-10 items-center justify-center rounded-full bg-gradient-to-r from-sky-500 via-cyan-400 to-pink-500 px-7 text-sm font-semibold text-white shadow-[0_12px_34px_rgba(56,189,248,0.28)] transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
                    >
