...
const PREVIEW_PATH = "/assets/monsters/mochiSoldier/mochiSoldier.glb";
...
export default function MochiSoldierPreview() {
  ...
  useEffect(() => {
    ...
    const ambient = new THREE.AmbientLight(0xf8fafc, 0.8);
    ...
    const frameCamera = () => {
      ...
      const distance = Math.max(distanceByHeight, distanceByWidth) * 1.14;
      camera.position.set(0, framedRadius * 0.06, distance);
      camera.lookAt(0, 0, 0);
    };
