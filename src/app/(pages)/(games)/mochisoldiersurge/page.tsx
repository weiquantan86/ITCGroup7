...
import MochiSoldierSurgeClient from "./MochiSoldierSurgeClient";
...
export default async function MochiSoldierSurgePage() {
  ...
  return <MochiSoldierSurgeClient characterOptions={characterOptions} />;
}
