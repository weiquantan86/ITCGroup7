...
const outPath = "public/assets/characters/eli/eli.glb";
...
const torso = new THREE.Mesh(
  new THREE.CylinderGeometry(0.5, 0.6, 1.25, 18),
  primaryMat
);
torso.position.y = 0.85;

const head = new THREE.Mesh(new THREE.ConeGeometry(0.42, 0.7, 20), primaryMat);
head.name = "head";
head.position.y = 1.65;

const antenna = new THREE.Mesh(
  new THREE.CylinderGeometry(0.03, 0.03, 0.4, 10),
  darkMat
);
...
antennaTip.position.set(0, 2.28, 0);
...
eyeLeft.position.set(-0.16, 1.6, 0.36);
eyeRight.position.set(0.16, 1.6, 0.36);
...
armLeftGroup.position.set(-0.6, 0.48, 0);
armRightGroup.position.set(0.6, 0.48, 0);
...
group.add(torso, head, antenna, antennaTip, eyeLeft, eyeRight, legLeftGroup, legRightGroup);
