...
const outPath = "public/assets/characters/felix/felix.glb";
...
const torso = new THREE.Mesh(
  new THREE.CapsuleGeometry(0.52, 1.15, 6, 18),
  primaryMat
);
...
const head = new THREE.Mesh(
  new THREE.CylinderGeometry(0.4, 0.4, 0.7, 20),
  primaryMat
);
head.name = "head";
head.position.y = 1.7;
...
const headBand = new THREE.Mesh(
  new THREE.TorusGeometry(0.38, 0.05, 10, 24),
  accentMat
);
headBand.rotation.x = Math.PI / 2;
headBand.position.set(0, 1.7, 0);
...
eyeLeft.position.set(-0.15, 1.68, 0.4);
eyeRight.position.set(0.15, 1.68, 0.4);
...
armLeftGroup.position.set(-0.58, 0.52, 0);
armRightGroup.position.set(0.58, 0.52, 0);
