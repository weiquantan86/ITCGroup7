...
export const createRuntime: CharacterRuntimeFactory = ({
  ...
  const punchConfig = {
    ...
    maxDamage: 29,
    hitRadius: 0.3,
    handModelRadiusScale: 0.92,
    handModelMinRadius: 0.58,
    handContactRadiusFallback: 0.42,
    handContactRadiusByCharge: 0.1,
    handContactForwardOffsetFallback: 0.46,
    handContactForwardOffsetByCharge: 0.1,
    handMaxHits: 8,
  };
  const skillRConfig = {
