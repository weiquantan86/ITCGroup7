...
const outPath = "public/assets/characters/harper/harper.glb";
...
const crestLeft = new THREE.Mesh(new THREE.ConeGeometry(0.08, 0.36, 10), darkMat);
const crestRight = new THREE.Mesh(new THREE.ConeGeometry(0.08, 0.36, 10), darkMat);
crestLeft.position.set(-0.28, 2.12, 0.02);
crestRight.position.set(0.28, 2.12, 0.02);
crestLeft.rotation.z = Math.PI / 6;
crestRight.rotation.z = -Math.PI / 6;
