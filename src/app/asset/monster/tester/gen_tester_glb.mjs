...
const outPath = "public/assets/monsters/tester/tester.glb";
...
const body = new THREE.Mesh(
  new THREE.CapsuleGeometry(0.52, 0.95, 6, 18),
  bodyMat
);
body.position.y = 0.99;

const head = new THREE.Mesh(new THREE.BoxGeometry(0.92, 0.9, 0.9), bodyMat);
head.position.y = 1.78;

const eyeGeo = new THREE.BoxGeometry(0.26, 0.05, 0.06);
const mouthGeo = new THREE.BoxGeometry(0.34, 0.05, 0.06);

const eyeLeft = new THREE.Mesh(eyeGeo, faceMat);
eyeLeft.position.set(-0.2, 1.78, 0.48);

const eyeRight = new THREE.Mesh(eyeGeo, faceMat);
eyeRight.position.set(0.2, 1.78, 0.48);

const mouth = new THREE.Mesh(mouthGeo, faceMat);
mouth.position.set(0, 1.64, 0.48);
