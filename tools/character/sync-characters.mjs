...
const generateCharacterCatalogSource = (characters) => {
  const defaultInitialCharacter = characters.find(
    (character) => character.id === "adam"
  );
  if (!defaultInitialCharacter) {
    throw new Error("Missing required default initial character: adam");
  }
...
const DEFAULT_INITIAL_CHARACTER_NAME = "${defaultInitialCharacter.label}";
